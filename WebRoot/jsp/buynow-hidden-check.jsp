...
String subTotal=Integer.toString(total);
 ...
 String select_sql="select * from "+tableName+" where goodsName='"+goodsName+"' and goodsDescribe='"+goodsDescribe+"' and goodsPrice='"+goodsPrice+"' and ordered='未下单' and clearing='结算中'";
 ...
 String insert_sql="insert into "+tableName+" (goodsName,goodsDescribe,goodsImg,goodsPrice,goodsNumber,subTotal,clearing)values('"+goodsName+"','"+goodsDescribe+"','"+goodsImg+"','"+goodsPrice+"','"+goodsNumber+"','"+subTotal+"','结算中')";
  try{ 
