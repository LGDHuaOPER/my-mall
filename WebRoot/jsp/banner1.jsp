...
<!--第一部分   导航区   开始 -->
    <div class="navigation-area">
 		<div class="common">
 			<div class="categories left">全部商品分类</div>
...
<!--第二部分左侧 商品详细列表 -->
	...
	<!--第二部分右侧  轮播图 -->
	<!--焦点图盒子-->
	<div class="second-pic right" id="picBox">
  ...
  try{
    ...
    String sql="select * from goods_tb where position='a' ";
    ResultSet rs=stmt.executeQuery(sql);
    while(rs.next()){
  %>
        <li><a href="<%=rs.getObject(8)%>"><img src="<%=rs.getObject(4)%>" thumb="" alt="" text="" /></a></li>
             <%
  }
   rs.close();
   stmt.close();
