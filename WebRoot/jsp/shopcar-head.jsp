    ...
    <!-- logo  搜索框  购物车 -->
 	...
 	<div class="header-bottom">
 		<div class="common">
 			...
 			<div class="left" style="width:280px;height:55px;font-size:26px;color:#fff;text-indent:30px;padding-top:30px;">购物车</div> 			
 			<div class="right" style="color:#f00;">
 		
 			<div class="oblong" style="background-color:#FF8000;"></div>
 			<div class="circle" style="background-color:#FF8000;color:#fff;">1</div>
 			<div class="oblong" style="background-color:#FF8000;"></div>
 			<div class="oblong" style="background-color:#ccc;"></div>
 			<div class="circle" style="background-color:#ccc;color:#fff;">2</div>
 			<div class="oblong" style="background-color:#ccc;"></div>
 			<div class="oblong" style="background-color:#ccc;"></div>
 			...
 			<div class="stage" style="color:#ccc">2.填写核对订单信息</div>
 			<div class="stage" style="color:#fff">1.我的购物车</div>
